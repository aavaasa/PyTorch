...
class VarAutoEncoderMnist(nn.Module):
...
model = VarAutoEncoderMnist(28 * 28, 28 * 28, 2)
...
d_train = torchvision.datasets.MNIST(r'C:\users\samsi\appdata\local\programs\python\python311\lib\site-packages\mnist', download=True, train=True, transform=transforms)
...
d_test = torchvision.datasets.MNIST(r'C:\users\samsi\appdata\local\programs\python\python311\lib\site-packages\mnist', download=True, train=True, transform=transforms)
...
for i in range(-n, n+1):
     for j in range(-n,n+1):
          ...
          predict = predict.detach().squeeze().view(28, 28)
