...
class ModelStyle(nn.Module):
    def __init__(self):
        super().__init__()
        _model = models.vgg19(weights='DEFAULT')
...
img = Image.open(r'').convert('RGB') # link to your image
img_style = Image.open(r'AI and ML\PyTorch\images\styler.jpg').convert('RGB') # link to style image
