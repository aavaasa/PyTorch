...
d_train = PhraseDataset(r"AI and ML\projects\Shiz rec\train data\train_data_normal", r"AI and ML\projects\Shiz rec\train data\train_data_shiz", navec)
...
load_xd = torch.load('model_rnn_bidir.tar', weights_only=False)
